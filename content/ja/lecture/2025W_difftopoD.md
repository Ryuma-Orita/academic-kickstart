...
**講義内容**
1. 道の空間に対するMorse理論 (PART III) の復習
2. 対称空間 (§20)
3. 対称空間としてのLie群 (§21)
...
6. 直交群に対するBott周期性定理 (§24)
	...
	[{{< icon name="youtube" pack="fab" >}}](https://youtu.be/aNW1i7oKFmM)
	[{{< icon name="youtube" pack="fab" >}}](https://youtu.be/HpPidSzePuU)
	[{{< icon name="youtube" pack="fab" >}}](https://youtu.be/Xn1ZCiSCd8k)
	[{{< icon name="youtube" pack="fab" >}}](https://youtu.be/LhNgS5ohPGQ)
	[{{< icon name="youtube" pack="fab" >}}](https://youtu.be/ClW6rNyItxg)
	[{{< icon name="youtube" pack="fab" >}}](https://youtu.be/rdd2p9Wc9FQ)
	[{{< icon name="youtube" pack="fab" >}}](https://youtu.be/_xUvBCbUBJI)
